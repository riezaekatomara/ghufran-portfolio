...
type Paket = {
  ...
  airlines: string[];
  bandara: string;
  hargaMulai?: number; // opsional bila situs tidak menampilkan pasti
  sumber: string; // url resmi referensi
};
...
const paketList: Paket[] = [
  ...
  },
  {
    ...
    bandara: "CGK – Soekarno-Hatta",
    // hargaMulai sengaja dikosongkan karena di halaman resmi dinamis
    sumber:
